...
class p3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._offset_range = Range(-10, 10, 0.0001, 0, 200)
        ...
        self._A_range = Range(0, 6, 0.01, 1, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, 2*A, -offset, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.ModulosEfren_Compara_0, 0))
